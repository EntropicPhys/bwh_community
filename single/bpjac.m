...
par = u( 2*p.nu +1:end);          % Parameter vector
%--- Unpack parameters ---%
...
ph1 = u(3 * n + 1: 4*n); ph2 = u(4*n+1 : 5 * n); ph3 = u(5 * n+1 : 6* n);
% === Construct the block matrices necesaries to compute du(G^T_u psi) ===
