...
global p2pglob % used for sparsity pattern
n = p.np; 
par=u(p.nu+1:end);
Db=par(15); Dw=par(16); Dh=par(17);l=par(19);
[f1b,f1w,f1h,f2b,f2w,f2h,f3b,f3w,f3h] = njac(p,u);
...
Gu= kron([[l^2*Db,0,0];[0,l^2*Dw,0];[0,0,l^2*Dh]],p.mat.K) - p.mat.M*Fu;
end
